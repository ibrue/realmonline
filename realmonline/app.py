...
def _create_app_class():
    """Lazily import rumps and define the App classes (macOS-only)."""
    import rumps
    ...
    return RealmOnlineApp, DemoRealmOnlineApp
...
def main():
    ...
    if args.test_auth:
        ...
        _, DemoRealmOnlineApp = _create_app_class()
        app = DemoRealmOnlineApp()
        app.run()
    else:
        RealmOnlineApp, _ = _create_app_class()
        app = RealmOnlineApp()
        app.run()
